...
public:
	// Gameplay effect to grant.
	UPROPERTY(EditDefaultsOnly)
	FGameplayAttribute AttributeSet;
...
UCLASS()
class PROJECTFISHING_API UAbilitySet : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	void GiveToAbilitySystem(UAbilitySystemComponent* LyraASC, FAbilitySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject = nullptr) const;
...
protected:
	...
	// Attribute sets to grant when this ability set is granted.
	UPROPERTY(EditDefaultsOnly, Category = "Attribute Sets", meta=(TitleProperty=AttributeSet))
	TArray<FAbilitySet_Attributes> AttributeStats;
