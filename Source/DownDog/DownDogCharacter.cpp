...
{	
	...
	{
		// Jumping
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Started, this, &ADownDogCharacter::DoJumpStart);
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Completed, this, &ADownDogCharacter::DoJumpEnd);

		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADownDogCharacter::MoveInput);
...
void ADownDogCharacter::DoMove(float Right, float Forward)
{
	if (GetController())
	{
...
void ADownDogCharacter::DoJumpStart()
{
	// pass Jump to the character
	Jump();
}

void ADownDogCharacter::DoJumpEnd()
{
